...
function textParser(responseContent) {
    // Clean the response
...
console.log("Test Case 1 Parsed:", JSON.stringify(textParser(testCase1), null, 2));
console.log("Test Case 2 Parsed:", JSON.stringify(textParser(testCase2), null, 2));
